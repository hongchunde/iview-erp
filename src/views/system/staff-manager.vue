        ...
        <Row>
            <Col span="24">
                <Card>
                    ...
                    <div class="edittable-test-con2">
                        可编辑单元格可配置可编辑的列，可设置编辑整行的可编辑单元格，也可配置单个编辑可编辑单元格，也可两种形式同时可用。可配置单元格内编辑的图标显示方式。
                        <Input v-model="searchConName1" icon="search" @on-change="handleSearch1" placeholder="请输入姓名搜索..." style="width: 280px" />
...
import tableData from './components/staff_table_data.js';
export default {
    name: 'editable-table',
    components: {
        canEditTable
